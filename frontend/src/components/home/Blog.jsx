                    ...
                    {blogs.slice(0, 3).map((blog) => (
                        <Link to={`/blogs/${blog.id}`}>
                            ...
                            >
                                ...
                                />
                                <div className="p-5">
                                    <p className="text-sm text-yellow-500 mb-2">{t(blog.dateKey)}</p>
                                    <h2 className="text-xl font-bold mb-2 line-clamp-1">{t(blog.titleKey)}</h2>
                                    <p className="text-gray-700 mb-4 line-clamp-2">{t(blog.descriptionKey)}</p>
